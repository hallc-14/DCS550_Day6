...
### Plot 7
ggplot(filter(bicycle, RoadCondition != 'Dry'), aes(RoadCondition)) + geom_bar()
...
<iframe src= "https://hallc.shinyapps.io/bicycle1/" width = "1100" height = "1200" style = "border:none;"></iframe>
